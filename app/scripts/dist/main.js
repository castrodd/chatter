...
var ChatApp = function ChatApp() {
  ...
  this.chatForm = new _dom.ChatForm('[data-chat="chat-form"]', '[data-chat="message-input"]');
  this.chatList = new _dom.ChatList('[data-chat="message-list"]', username);
